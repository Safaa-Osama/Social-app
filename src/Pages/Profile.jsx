...
export default function Profile() {
  ...
  <div className="flex justify-center mt-5">
    <a href="#" className="text-blue-400 hover:text-blue-700 mx-3">Twitter</a>
    <a href="#" className="text-blue-400 hover:text-blue-700 mx-3">LinkedIn</a>
    <a href="#" className="text-blue-400 hover:text-blue-700 mx-3">GitHub</a>
  </div>
  <div className="mt-5">
